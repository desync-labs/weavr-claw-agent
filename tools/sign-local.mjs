 ...
 * and a contrary `--wallet` on its command line is a CONFIG refusal. A local
 * key signs v0 as well as legacy transactions, so a create of any size goes
 * through here where sign-solana.mjs refuses v0 (LEGACY_ONLY). See sign.mjs
 * for the commands and the environment.
 */
