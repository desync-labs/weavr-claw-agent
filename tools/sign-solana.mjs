 ...
 * and a contrary `--wallet` on its command line is a CONFIG refusal. The PayBox
 * CLI decodes legacy transactions only, so a v0 transaction is refused here
 * (exit 2 LEGACY_ONLY) where sign-local.mjs signs it. See sign.mjs for the
 * commands and the environment.
 */
